            ...
            >
              <div className="flex h-full">
                ...
                <div className="flex-1 p-4 sm:p-6 md:p-8 flex flex-col justify-center">
                  <span
                    className={`text-xs font-bold tracking-wider ${category.textColor}`}
                  >
                    {category.highlight}
                  </span>
                  ...
                  <div className="mt-4">
                    <span
                      className={`inline-flex items-center text-sm font-semibold ${category.textColor}`}
                    >
                      {getProductsByCategory(category.categoryKey).length}{" "}
                      Products
                      <svg
