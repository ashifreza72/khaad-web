    ...
    <>
      ...
      >
        ...
        <div className="p-3 sm:p-4 overflow-y-auto flex-grow">
          {cartItems.length === 0 ? (
            <p className="text-green-600 text-center py-8">Your cart is empty.</p>
          ) : (
                ...
                >
                  <div className="flex items-center gap-3 sm:gap-4">
                    ...
                    <div className="flex-grow min-w-0">
                      ...
                      <p className="text-xs sm:text-sm text-green-600">Size: {item.size}</p>
        ...
        <div className="p-3 sm:p-4 border-t border-green-200 mt-auto bg-green-50">
          <div className="flex justify-between items-center mb-3">
            <span className="text-base sm:text-lg font-semibold text-green-800">Total:</span>
            <span className="text-lg sm:text-xl font-bold text-green-700">₹{calculateTotal()}</span>
          </div>
          <button
